...
def print_results(results_dic, results_stats_dic, model,
    ...
    print(f"{'N Not-Dog Images':<20}: {n_notdogs_img:3d}")
    ...
    if (print_incorrect_dogs and
        ...
        for key in results_dic:
            ...
            match_label = results_dic[key][3]
            classifier_label = results_dic[key][4]
            is_mismatch = (match_label == 1 and classifier_label == 0) or (match_label == 0 and classifier_label == 1)

            if is_mismatch:
                print("Mismatch: ",results_dic[key][0], results_dic[key][1])
